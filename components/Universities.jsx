...
const Trobe = "/assets/La Trobe University.webp";
const Tas = "/assets/University of Tasmania.svg";
const Charles = "/assets/Charles Sturt University.svg";
const Torrens = "/assets/Torrens University.webp";
const Southern = "/assets/Southern Cross University (1).webp";
const Murdoch = "/assets/Murdoch University.webp";
const Sunshine = "/assets/University of the Sunshine Coast.webp";
const CQUN = "/assets/CQUniversity.svg";
const ECU = "/assets/Edith Cowan University.webp";
const JCU = "/assets/James Cook University.webp";
const USQ = "/assets/University of Southern Queensland.svg";
const VU = "/assets/Victoria University.svg";
const UN = "/assets/University of Newcastle.webp";
const UW = "/assets/University of Wollongong.webp";
const EUC = "/assets/Excelsia College.webp";
const ACAP = "/assets/ACAP University College.webp";
const SAE = "/assets/SAE University College.webp";
const THS = "/assets/The Hotel School.svg";
const BMIHMS = "/assets/Blue Mountains International Hotel Management School.svg";
const MP = "/assets/Melbourne Polytechnic.webp";
const HI = "/assets/Holmes Institute.webp";
const CI = "/assets/Chisholm Institute.avif";
const BHI = "/assets/Box Hill Institute.webp";
const MIT = "/assets/Melbourne Institute of Technology.webp";
const KBS = "/assets/Kaplan Business School.svg";
const APIC = "/assets/APIC.webp";
const VIT = "/assets/VIT.webp";
const ICHM = "/assets/ICHM.webp";
const SC = "/assets/Stotts College.avif";
const NV = "/assets/Navitas University.svg";
const HOI = "/assets/Holmes Institute.webp";
const ECA = "/assets/ECA.webp";
const AIH = "/assets/AIH.svg";
const EIT = "/assets/EIT.webp";
const KOI = "/assets/KOI.webp";
const SCEL = "/assets/Southern Cross University (1).webp";
const CHE = "/assets/CIC.webp";
const KI = "/assets/Kent Institute.webp";
const WI = "/assets/Wentworth Institute.webp";
const IIBIT = "/assets/IIBIT.webp";
const TEI = "/assets/Top Education Institute.webp";
const EI = "/assets/Equal International.webp";
const CIM = "/assets/Canterbury Institute.webp";
const TN = "/assets/TAFE NSW.webp";
const IIA = "/assets/IKON Institute.svg";
const IHM = "/assets/IHM.svg";
const GHE = "/assets/Global Higher Education.webp";
const CIBT = "/assets/Crown Institute of Business and Technology.gif";
const ICMS = "/assets/ICMS.webp";
